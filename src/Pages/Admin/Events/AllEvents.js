...
const AllEvents = () => {
  ...
  const renderAllBlogs = async () => {
    try {
      await axios.get(`${BACKEND_BASE_URL}/api/admin/events`).then((res) => {
  ...
  const showSingleEventData = (modalValue, id) => {
    axios.get(`${BACKEND_BASE_URL}/api/admin/events/view/${id}`).then((res) => {
      setModalData(true);
  ...
  const deleteData = async (id) => {
    ...
    if (isConfirm) {
      axios
        .delete(`${BACKEND_BASE_URL}/api/admin/events/delete/${id}`)
        .then((res) => {
          Swal.fire({
            icon: "success",
                  ...
                  {eventsInfo.map((data, index) => (
                    <tr>
                      ...
                      <td>
                        {/* view button */}
                        <button
                          onClick={() => showSingleEventData("View", data.id)}
